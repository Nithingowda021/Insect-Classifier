...
class main_page:
    def __init__ (self, window):
        self.window = window
        self.window.title("Deep Learning based Insect Classification")
    ...
    def Train_the_complete_dataset(self, dummy):
        ...
        train_generator = train_datagen.flow_from_directory('E:/CP-2020/Insect Project/My_Code/Insects/',target_size=(200, 200),batch_size=batch_size,classes=['Auchenorrhyncha', 'Heteroptera', 'Hymenoptera', 'Lepidoptera', 'Megalptera', 'Neuroptera', 'Odonata',
